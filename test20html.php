...
if (isset($_GET['download']) and $_GET['download'] == 'true') {
	...
	<head>
		...
		<style type="text/css">
			...
			.form-dropdown:hover>.dropdown-form {
				visibility: visible;
				opacity: 1;
			...
			.form fieldset:last-child input[type="checkbox"] {
				flex: none;
				margin-left: -1px;
				margin-top: 1px;
				padding: 0;
			...
			form fieldset:last-child input[type="checkbox"]:hover {
				border-color: #B3B5B8;
			}

			form fieldset:last-child input[type="checkbox"]:checked {
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						<li class="form-dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
								aria-haspopup="true" aria-expanded="false">Кабінет</a>

							<form action="#" method="post" class="form dropdown-menu dropdown-form">
								<h5 class="form-title"><span>first name</span> settings</h5>
								<fieldset>
									<label for="label">Label</label>
									<input type="text" name="label" value="First Name">
								</fieldset>
								<fieldset>
